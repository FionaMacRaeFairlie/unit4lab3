...
const Products = ({ match }) => {
    const productData= [
        {name:"carrot cake",description:"home made here",price:"2.50",category:"cake",available:"yes",id:1},
        {name:"sandwiches",description:"with a variety of fillings",price:"2.50",category:"snack",available:"yes",id:2},
